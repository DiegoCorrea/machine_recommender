...
from src.machine_learning.manual_implamantation.k_neighbors_classifier import KNeighborsClassifier
from src.machine_learning.manual_implamantation.naive_bayes_classifier import NaiveBayesClassifier


class MachineAlgorithms:

    @staticmethod
    def __train_naive_bayes(x_train, x_test, y_train, y_test, run):
        """
